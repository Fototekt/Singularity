...
INSERT INTO organizations (name, domain, subscription_tier, subscription_status) 
VALUES ('System Administration', 'system.local', 'enterprise', 'active');

INSERT INTO users (organization_id, email, password_hash, first_name, last_name, role, status, email_verified) 
VALUES (1, 'admin@system.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'System', 'Admin', 'system_admin', 'active', TRUE);

-- Insert default compliance rules
INSERT INTO compliance_rules (organization_id, name, description, rule_type, rule_data, created_by)
VALUES 
